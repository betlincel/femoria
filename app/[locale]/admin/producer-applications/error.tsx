...
export default function AdminProducerApplicationsError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
    ...
    <section className="prototype-page">
      <div className="prototype-card">
        ...
        <div className="prototype-actions">
          <button className="btn btn-primary" type="button" onClick={reset}>{ui.retry}</button>
